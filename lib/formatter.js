...
function formatImage(elem, walk, builder, formatOptions) {
  ...
  const alt = (attribs.alt)
    ? (builder.options.decodeOptions ? he.decode(attribs.alt, builder.options.decodeOptions) : attribs.alt)
    : '';
...
function formatAnchor(elem, walk, builder, formatOptions) {
  function getHref() {
    ...
    href = (formatOptions.baseUrl && href[0] === '/')
      ...
      : href;
    return builder.options.decodeOptions ? he.decode(href, builder.options.decodeOptions) : href;
  }
  const href = getHref();
  if (!href) {
    walk(elem.children, builder);
